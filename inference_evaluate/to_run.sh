...
synthetic_prompts_file_path = "../synthetic_data_generator/prompts/synthetic_HCT-all_prompts.jsonl"
...
python3 vlm_mlm_inference.py --model "OpenGVLab/InternVL2-4B" --output_folder $vlm_text_inference_results_path

# "llava-hf/llava-1.5-7b-hf",
python3 vlm_mlm_inference.py --model "llava-hf/llava-1.5-7b-hf" --output_folder $vlm_text_inference_results_path

# "llava-hf/llava-v1.6-mistral-7b-hf",
python3 vlm_mlm_inference.py --model "llava-hf/llava-v1.6-mistral-7b-hf" --output_folder $vlm_text_inference_results_path

# "llava-hf/llava-v1.6-vicuna-7b-hf",
python3 vlm_mlm_inference.py --model "llava-hf/llava-v1.6-vicuna-7b-hf" --output_folder $vlm_text_inference_results_path

# "allenai/Molmo-7B-D-0924",
python3 vlm_mlm_inference.py --model "allenai/Molmo-7B-D-0924" --output_folder $vlm_text_inference_results_path
    
# "google/paligemma2-10b-ft-docci-448",
python3 vlm_mlm_inference.py --model "google/paligemma2-10b-ft-docci-448" --output_folder $vlm_text_inference_results_path

# "mistralai/Pixtral-12B-2409",
python3 vlm_mlm_inference.py --model "mistralai/Pixtral-12B-2409" --output_folder $vlm_text_inference_results_path

# "microsoft/Phi-3-vision-128k-instruct",
python3 vlm_mlm_inference.py --model "microsoft/Phi-3-vision-128k-instruct" --output_folder $vlm_text_inference_results_path
    
# "microsoft/Phi-3.5-vision-instruct",
python3 vlm_mlm_inference.py --model "microsoft/Phi-3.5-vision-instruct" --output_folder $vlm_text_inference_results_path
    
# "Qwen/Qwen2-VL-7B-Instruct"
python3 vlm_mlm_inference.py --model "Qwen/Qwen2-VL-7B-Instruct" --output_folder $vlm_text_inference_results_path
