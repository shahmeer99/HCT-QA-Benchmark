...
## which contain an array of tables looking like (same JSON as manually generated by interface (TBA)):
# [{
#   ' name' : ' table1' ,
#   ' replica' : 5, 
...
# do not excedd more than 2 levels for rows and 3 for columns
# Typical format: 
...
tablePatternsJSONfile = "tablePatterns_forPromptLLM.json"    # file containing table patterns
##tablePatternsJSONfile = "tablePatterns_all.json"    # file containing table patterns
#tablePatternsJSONfile = "tablePatterns_new_only.json"    # file containing table patterns

#### OUTPUT
outputFolder = "./PARAMETERS/"
tableOutputJSONfile = "tablesToGenerate_forPromptLLM.json"    # file containing all detailed tables to generate
##tableOutputJSONfile = "tablesToGenerate_all.json"    # file containing all detailed tables to generate
